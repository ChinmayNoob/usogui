    ...
    return (
        <div className="w-full h-full flex items-center justify-center">
            <motion.div
                ...
                className="h-[500px] w-[500px] rounded-[30px] px-4 py-5 relative overflow-hidden"
            >
                <motion.div
...
const Gallery = (props: { item: Element; index?: number }) => {
    return (
        ...
        >
            <img src={props.item.img} className="w-full h-full object-cover" />
        </motion.div>
    );
};
